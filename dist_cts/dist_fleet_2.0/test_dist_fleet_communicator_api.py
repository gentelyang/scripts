...
class TestApi():
    ...
    def test_all_reduce(self):
        """test_all_reduce"""
        cmd = 'fleetrun dist_collective_all_reduce.py'
        pro = subprocess.Popen(cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        out, err = pro.communicate()
        print(out)
        pro.wait()
    ...
    def test_broadcast(self):
        """test_broadcast"""
        cmd = 'fleetrun dist_collective_broadcast.py'
        pro = subprocess.Popen(cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        out, err = pro.communicate()
        print(out)
        pro.wait()
    ...
    def test_parallelenv(self):
        """test_parallelenv"""
        cmd = 'fleetrun dist_collective_parallelenv.py'
        pro = subprocess.Popen(cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        out, err = pro.communicate()
        print(out)
        pro.wait()
    ...
    def test_reduce(self):
        """test_reduce"""
        cmd = 'fleetrun dist_collective_reduce.py'
        pro = subprocess.Popen(cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        out, err = pro.communicate()
        print(out)
        pro.wait()
    ...
    def test_reduceop(self):
        """test_reduceop"""
        cmd = 'fleetrun dist_collective_reduceop.py'
        pro = subprocess.Popen(cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        out, err = pro.communicate()
        print(out)
        pro.wait()
