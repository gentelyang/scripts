...
/***************************************************************************
  ...
  * @file test_dist_fleet_static_vgg.py
...
class TestDistVgg16(TestFleetBase):
        ...
        @run_priority(level='P0')
        def test_1t_2g_Tsharding(self):
            """test_1t_2g_Tsharding."""
            TestFleetBase.__init__(self, pservers=0, trainers=1)
            self.run_params = {
                'dgc': False,
                'lars': False,
        ...
        # 策略融合策略测试case
        @run_priority(level='P0')
        def test_1t_2g_Trecompute_Tamp(self):
            """test_1t_2g_Tre_Tamp."""
            TestFleetBase.__init__(self, pservers=0, trainers=1)
            self.run_params = {
                'dgc': False,
        ...
        @run_priority(level='P0')
        def test_1t_2g_Tre_Tamp_Tlars(self):
            """test_1t_2g_Tre_Tamp_Tlars."""
            TestFleetBase.__init__(self, pservers=0, trainers=1)
            self.run_params = {
                'dgc': False,
                'lars': True,
        ...
        @run_priority(level='P0')
        def test_1t_2g_Tamp_Tlocalsgd(self):
            """test_1t_2g_Tamp_Tlocalsgd."""
            TestFleetBase.__init__(self, pservers=0, trainers=1)
            self.run_params = {
                'dgc': False,
                'lars': False,
        ...
        @run_priority(level='P0')
        def test_1t_2g_Tre_Tlars(self):
            """test_1t_2g_Tre_Tlars."""
            TestFleetBase.__init__(self, pservers=0, trainers=1)
            self.run_params = {
                'dgc': False,
                'lars': True,
